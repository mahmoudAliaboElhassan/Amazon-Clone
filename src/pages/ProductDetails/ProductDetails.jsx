...
import mini1 from "../../assets/images/mini-1.png"
            ...
            <section className="font-ibm">
                <div className="container px-[20px] sm:px-0">
                    <div className="text-[#787878] my-1">
                        <p>Fashion &gt; Women &gt; Clothing &gt; Dresses</p>
                    </div>
                    <div id="item" className="flex justify-between flex-col lg:flex-row">
                        <div className="main-sub-images lg:w-[50%] w-full mb-[20px]">
                            <div className="grid grid-cols-1 w-[40px] gap-3 mt-4">
                                <div className="card border-[2px] border-solid border-[#1F8394] rounded-[3.9px]">
                                    <img src={mini1} alt="" className="w-full " />
                                </div>
                                <div className="card ">
                                    <img src={mini1} alt="" className="w-full" />
                                </div>
                        ...
                        <div className="flex lg:w-[70%] w-full flex-col sm:flex-row gap-[31px]">
                            <div className="flex flex-col ">
                                <div className="flex flex-col gap-[7.4px]">
                                    <span className="text-cyan font-inika">Brand: WDIRARA</span>
                                    <h3 className="text-[25px] text-[#5C5C5C]">LG 7 Kg, 5 Star, Direct Drive Technology, Steam Wash, 6 Motion DD, Smart Diagnosis, Fully-Automatic Front Load</h3>
                                    <div className="flex justify-between w-full max-w-[385px] lg:flex-col xl:flex-row flex-col sm:flex-row">
                                        <div className="flex items-center">4.1 <IoIosStar className="text-[#FFCC00]" /><IoIosStar className="text-[#FFCC00]" /><IoIosStar className="text-[#FFCC00]" /><IoIosStar className="text-[#FFCC00]" /><IoIosStarOutline className="text-[#FFCC00]" /> <i className="fa-solid fa-chevron-down"></i></div>
                                        <div className="flex gap-[16.4px] items-center"><span className="text-cyan">67 ratings</span>|<span className="text-cyan">Search this page</span></div>
                                    </div>
                                </div>
                                <div className="border-t-[1px] border-solid border-[#D9D9D9] mt-2 pt-2 gap-[13.7px] flex flex-col">
                                    <span className="text-[31.3px]"><sup className="text-[14.8px] top-[-15px]">SAR</sup>203<sup className="text-[14.8px] top-[-15px]">14</sup></span>
